...
\begin{abstract}
 ...
 Applying these to the first two gravitational-wave binary neutron star mergers GW170817 and GW190425, constraints on the radius of a $1.4\,M_\odot$ neutron star improves from $R_{1.4}={12.54^{+1.05}_{-1.54}}\,{\rm km}$ to $12.11^{+0.91}_{-1.11}\,{\rm km}$ (90\% confidence intervals).
