...
\begin{document}
	...
	%Applying these observational constraints reduces our initial set of $8 \times 10^6$ EOSs to approximately $10^6$ viable models, forming the basis for the results in the next section.
	
	%While an upper bound on $M_{\rm TOV}$ has been proposed ($M_{\rm TOV} \lesssim 2.16^{+0.17}{-0.15} M{\odot}$, see \citet{Rezzolla2017} and also \citet{Margalit2017, Ruiz2017, Shibata2019, Nathanail2021}), this estimate relies on model assumptions about the kilonova associated with GRB170817A from GW170817. Given these uncertainties, we do not impose this bound in our main analysis but explore its impact in Appendix~\ref{sec:appendix_a}.
